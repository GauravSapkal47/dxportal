...
export class InternalportalserviceService {
  ...
  getinvoicedetailsbasedonemailid(emailid: string,mpage,status,invno,pono,fdate,tdate,plant,vendor) {
    ...
    return this.http.post<any>(AppSettings.getinvoicedetailsbasedonemailidS, jsonData, {withCredentials:true })
  }
  ...
  updateManagerApprovalStatus(InvoiceNumber,ponumber,managerstatus,managerId,stage,invdate,bussinessOID) {
    // console.log("sending Data", PAN)
    let urlSearchParams: HttpParams = new HttpParams();
    urlSearchParams =  urlSearchParams.append('INVOICENUMBER', InvoiceNumber);
    urlSearchParams =  urlSearchParams.append('PONUMBER', ponumber);
    ...
    urlSearchParams =  urlSearchParams.append('stage', stage);
    urlSearchParams =  urlSearchParams.append('INVOICEDATE', invdate);
    urlSearchParams =  urlSearchParams.append('Bid', bussinessOID);
    let jsonData = urlSearchParams.toString();
    // console.log("URL",baseURL)
    return this.http.post<any>(AppSettings.managerapprovalstatus, jsonData, {withCredentials:true })
  }

  updateManagerApprovalStatusSimpo(InvoiceNumber,ponumber,managerstatus,managerId,stage,invdate,bussinessOID) {
    // console.log("sending Data", PAN)
    let urlSearchParams: HttpParams = new HttpParams();
    urlSearchParams =  urlSearchParams.append('INVOICENUMBER', InvoiceNumber);
    urlSearchParams =  urlSearchParams.append('PONUMBER', ponumber);
    ...
    let jsonData = urlSearchParams.toString();
    // console.log("URL",baseURL)
    return this.http.post<any>(AppSettings.managerapprovalstatusforsimpo, jsonData, {withCredentials:true })
  }
...
getInternalBuyerInvoiceData(emailid:string){
  ...
  getInvoicesbasedonUserTypeSimpo(emailid:string,mpage,status,invno,pono,fdate,tdate,plant,vendor){
    let urlSearchParams: HttpParams = new HttpParams();
    urlSearchParams =  urlSearchParams.append('emailid', emailid);
    urlSearchParams =  urlSearchParams.append('page', mpage);
    urlSearchParams =  urlSearchParams.append('status', status);
    ...
    urlSearchParams =  urlSearchParams.append('vendor', vendor);
    let jsonData = urlSearchParams.toString();
    return this.http.post<any>(AppSettings.InvoicesbasedonUserTypeSimpo, jsonData, {withCredentials:true })

  }

  getlistitemsforinvoicenumbersS(data,ponumber)
   {
     let urlSearchParams: HttpParams = new HttpParams();
     urlSearchParams =  urlSearchParams.append('invoice', data);
     for(let i=0; i < ponumber.length; i++)
     {
       console.log(ponumber[i],'ponumber[i]')
       urlSearchParams = urlSearchParams.append('po_num_list', ponumber[i]);
     }
     let jsonData = urlSearchParams.toString();
     return this.http.post<any>(AppSettings.getinternallistitemsforinvoicenumberS,jsonData,{withCredentials: true})
    }
  ...
  getEndUserReturnSimpo(array){
    ...
    let jsonData = urlSearchParams.toString();
    return this.http.post<any>(AppSettings.getEndUserReturnSimpo,array,{withCredentials:true})
  }


  updateacceptedquantityofinvoicewithoutgrnforsimpo(model) {
    // console.log(poNumber)
    let urlSearchParams: HttpParams = new HttpParams();
  ...
  let jsonData = urlSearchParams.toString();
    ...
    return this.http.post<any>(AppSettings.updateacceptedquantityofinvoicewithoutgrnforsimpo, jsonData, {responseType: "json", withCredentials: true })
  }
  ...
  updateacceptedservicequantityofinvoiceforsimpo(model)
  {
    let urlSearchParams: HttpParams = new HttpParams();
  model.forEach(feedback => {
  ...
  let jsonData = urlSearchParams.toString();
    ...
    return this.http.post<any>(AppSettings.updateacceptedservicequantityofinvoiceforsimpo, jsonData, {responseType: "json", withCredentials: true })
  ...
  updateacceptedservicequantityofinvoicewithoutgrnforsimpo(model)
  {
    let urlSearchParams: HttpParams = new HttpParams();
  model.forEach(feedback => {
  ...
  let jsonData = urlSearchParams.toString();
    ...
    return this.http.post<any>(AppSettings.updateacceptedservicequantityofinvoicewithoutinvoiceforsimpo, jsonData, {responseType: "json", withCredentials: true })
  ...
  updateacceptedquantityofinvoiceformultigrn(model) {
    // console.log(poNumber)
    let urlSearchParams: HttpParams = new HttpParams();
  ...
  let jsonData = urlSearchParams.toString();
    ...
    return this.http.post<any>(AppSettings.updateacceptedquantityofinvoiceformultigrn, jsonData, {responseType: "json", withCredentials: true })
  }
