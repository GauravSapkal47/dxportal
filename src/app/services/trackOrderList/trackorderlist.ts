...
export class TrackOrderListService {
  ...
  getVendorReturnforsimpo(poNumber,invNumber) {
    let urlSearchParams: HttpParams = new HttpParams();
    urlSearchParams = urlSearchParams.append('po_num', poNumber);
    urlSearchParams = urlSearchParams.append('invoice', invNumber);
    let jsonData = urlSearchParams.toString();
    ...
    return this.http.post<any>(AppSettings.getVendorReturnforsimpo, jsonData, { headers: this.headers, responseType: "json", withCredentials: true })
  }
...
getMultiPoLineItemDetail(data,ponumberList)
{
  let urlSearchParams: HttpParams = new HttpParams();
  urlSearchParams =  urlSearchParams.append('invoice', data);
  for(let i=0; i < ponumberList.length; i++)
  {
    console.log(ponumberList[i],'ponumberList[i]')
    urlSearchParams = urlSearchParams.append('po_num_list', ponumberList[i]);
  }
  let jsonData = urlSearchParams.toString();
  return this.http.post<any>(AppSettings.getsimpoInvoiceLineItemDetails,jsonData,{headers: this.headers,responseType: "json", withCredentials: true})
}

getMultiPoLineItemDetailForVendor(data,ponumberList)
{
  let urlSearchParams: HttpParams = new HttpParams();
  urlSearchParams =  urlSearchParams.append('invoice', data);
  for(let i=0; i < ponumberList.length; i++)
  ...
  let jsonData = urlSearchParams.toString();
  return this.http.post<any>(AppSettings.getsimpoTrackInvoiceLineItemDetails,jsonData,{headers: this.headers,responseType: "json", withCredentials: true})
}
