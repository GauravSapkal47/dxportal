...
export class InternalportaldashboardComponent implements OnInit {
  ...
  multiPOData(invoicenumber, ponumber, multiponumber) {
    ...
    if (multiponumber == undefined) {
      ...
      this.router.navigate(['./Internalmultitrackinvoicedetails'], { queryParams: { order: btoa(invoicenumber), po: btoa(ponumber), mpo: btoa(multiponumber),origin:btoa('internaldashboard') } });
    }
  }
