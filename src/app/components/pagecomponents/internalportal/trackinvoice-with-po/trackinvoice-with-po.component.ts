...
export class TrackinvoiceWithPOComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log("this.usertype ==> " + this.typeid);
    console.log("this.usertype ==> " + this.storekeeper);
...
console.log("this.type" +type);
    setTimeout(() => {
      ...
      if (this.managerStatusDisplay == 'CO')
        $("#selectuser").val('P') // to be checked
...
console.log("this.typeid "+this.typeid);
      ...
      if (endUserStatus != this.enduserStatusDisplay) {
        ...
        dialogRef.afterClosed().subscribe(result => {
          ...
          if (this.confirmationValue == true) {
            this.loaderservice.show();
            console.log("update store action");
      ...
      if (manstat == 'V') {
        ...
        if (managerStatus != this.managerStatusDisplay) {
          ...
          dialogRef.afterClosed().subscribe(result => {
            ...
            console.log('test value', result.return);
            this.msgOnButtonClick = value1.messageString;
            this.confirmationValue = result.return;
                              ...
                              if (res3[0].message = "shortfall Creditadvice created Sucess") {
                                if (res3[0].grn != "") {
                                  ...
                                  && res3[0].warningMessage != "null") {
                                    var showmessage = 'GRN No.' + this.grnnumber + ' created for Invoice No. ' + this.invoicedata[0].INVOICENUMBER + '. Request for Credit Note sent to the Vendor. WARNING: ' + res3[0].warningMessage;
  ...
  // getcount(enduserremark:string)
  // {
  //   return enduserremark.length;
  // }
