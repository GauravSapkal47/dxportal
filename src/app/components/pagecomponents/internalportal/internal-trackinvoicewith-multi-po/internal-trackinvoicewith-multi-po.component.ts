...
@Component({
  selector: 'app-internal-trackinvoicewith-multi-po',
  templateUrl: './internal-trackinvoicewith-multi-po.component.html',
  styleUrls: ['./internal-trackinvoicewith-multi-po.component.css']
})
export class InternalTrackinvoicewithMultiPOComponent implements OnInit {
  addcount: number = 1;
  invoicedata: any = [];
  grnList: any = [];
  grnmultiList: any = [];
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      this.mpoParamdata = params.mpo;
      console.log(this.mpoParamdata, 'mpoParamdata');
      if (this.mpoParamdata != undefined) {
        this.mpodata = atob(this.mpoParamdata)
        if (this.mpodata != undefined) {
          //this.multiPOList.push(this.mpodata);
          console.log(this.multiPOList, 'this.multiPOList')
          const myArray = this.mpodata.split(",");
          for (let i = 0; i < myArray.length; i++) {
            this.multiPOFinalList.push(myArray[i])
          }
          console.log(this.multiPOFinalList, 'this.multiPOFinalList')
        }
      }
      else {
  ...
  displayTypeBasis(type) {
    console.log("this.managerstatusval " + this.managerstatusval);
    ...
    setTimeout(() => {
      ...
      if (type == "enduser" && this.enduserStatusDisplay == 'P') {
        $("#selectuser").prop('disabled', true);
      }
  ...
  getInvoiceDetails(ponum, invno) {
    ...
    this.trackOrderListService.getMultiPoLineItemDetail(invno, this.multiPOFinalList).subscribe(res => {
      ...
      if (res[0].message == "Success") {
        ...
        console.log(this.invoideDetailData[0].ACCEPTTYPE, 'this.invoideDetailData[0].ACCEPTTYPE')
      ...
      if (manstat == 'V') {
        ...
        if (managerStatus != this.managerStatusDisplay) {
          ...
          dialogRef.afterClosed().subscribe(result => {
            ...
            this.confirmationValue = result.return;
            // this.dialogBox.popUpOpen_callback_confirm('Do you want to update your invoice status to ' + this.managerStatus + '?', '1', 'confirm',
            //   (value) => {
            //     this.confirmationValue = value;
            //     console.log("value is here ==>" + value);
            ...
            if (this.confirmationValue == true) {
              ...
              if (this.confirmer == true) {
                      ...
                      if (res[0].pendingcount == "1" && res[0].message == "Success") {
                        if (res[0].message == "Success") {
                          ...
                          if (this.grnnumber != null && this.grnnumber != "" && this.grnnumber != undefined
                            ...
                            if (res[0].warningMessage != "" && res[0].warningMessage != null
                              && res[0].warningMessage != "null") {
                ...
                this.internalportalservice.updateManagerApprovalStatusSimpo(this.inVNumber,
                  this.poNumber, managerStatus, this.managerID, 2, $('#invdateval').text(), this.bussinesspartneroid).subscribe(res => {
              ...
              // $("#selectuser").val(this.managerStatusDisplay);
              console.log("inhere");
              console.log('test value', this.enduserStatusDisplay);
              // $("#selectManager").val(this.enduserStatusDisplay);
              if (this.typeid == "manager" && (this.managerStatusDisplay == 'CM' || this.managerStatusDisplay == 'CO')) {
    ...
    if (endUserStatus != this.enduserStatusDisplay) {
      ...
      dialogRef.afterClosed().subscribe(result => {
        ...
        if (this.confirmationValue == true) {
          ...
          // $("#selectuser").val(this.managerStatusDisplay);
          // this.submitdone = true;
          console.log("yes here" + this.typeid);
          // $("#selectManager").val(this.enduserStatusDisplay);
          if (this.typeid == "enduser") {
            ...
            if (this.typeid == "manager" && (this.managerStatusDisplay == 'CM' ||
              this.managerStatusDisplay == 'CO')) {
  ...
  getlineitemdetails() {
    ...
    this.internalportalservice.getlistitemsforinvoicenumbersS(this.inVNumber, this.multiPOFinalList).subscribe(res => {
      if (res[0].message == "Success") {
        ...
        for (let i = 0; i < this.invoicedata.length; i++) {
          ...
          console.log(this.invoicedata[i].PO_NUMBER, 'this.invoicedata')
          // for(var k=0;k<this.invoicedata.length;k++)
          // {
          //   if(!this.grnList.includes(this.invoicedata[k].PO_NUMBER))
          //   {
          // for (var b = 0; b < this.multiPOFinalList.length; b++) {
          //   if (this.multiPOFinalList[b] == this.invoicedata[k].PO_NUMBER) {
          //     this.grnList.push(this.invoicedata[k].GRNNUMBER);
          //   }
          // }
          //   }
          // }
          // this.grnList.push(this.invoicedata[i].GRNNUMBER);
          this.srcntotallist.push(this.invoicedata[i].SCRNNUMBER);
          console.log(this.srcntotallist, 'this.srcntotallist********************')
          // this.seletedValue[i] = "5000";
          // }

        }
        for (var b = 0; b < this.multiPOFinalList.length; b++) {
          for (var c = 0; c < this.invoicedata.length; c++) {
            if (this.multiPOFinalList[b] == this.invoicedata[c].PO_NUMBER) {
              this.grnList.push(this.invoicedata[c].GRNNUMBER);
              break
            }
          }

        }
        let filtered = this.srcntotallist.filter((a, b) => this.srcntotallist.indexOf(a) === b)
        for (var k = 0; k < filtered.length; k++) {
          if (filtered[k] != null && filtered[k] != undefined && filtered[k] != "") {
            this.srcnnumbers = this.srcnnumbers + filtered[k] + ",";
          }

        }
        this.srcnnumbers = this.srcnnumbers.slice(0, -1);
        ...
        if (res2[0].message == "Success") {
          ...
          if (this.self == true) {
            if (!this.invoicedata[0].LINEITEMNUMBER.includes('-')) {
              // this.internalportalservice.updateacceptedquantityofinvoice(this.invoicesubmissionarray).
              //   subscribe(res => {
              this.internalportalservice.updateacceptedquantityofinvoiceformultigrn(this.invoicesubmissionarray).
                subscribe(res => {
                  ...
                  if (res[0].message == "Success") {
                    ...
                    this.internalportalservice.updateenduseretails(this.multipleactualfilename, this.multiplesavedfilename,
                      ...
                      subscribe(res1 => {
                        if (res1[0].message == "Success") {
                          for (var p = 0; p < this.invoicedata.length; p++) {
                            this.grnmultiList.push(res[0].grn[0][this.invoicedata[p].PO_NUMBER]);
                            console.log(this.grnmultiList, 'this.grnmultiList*****************');
                            this.grnmultiList = this.grnmultiList.filter(
                              (element, i) => i === this.grnmultiList.indexOf(element)
                            );
                            console.log(this.grnmultiList);
                            // var mySet = new Set(this.grnmultiList);
                            // this.uniqueGRN = [mySet];
                            // this.uniquGRNList.push(this.uniqueGRN);
                            // console.log(this.uniquGRNList);
                            if (this.grnmultiList[p] != undefined)
                              this.grnString += this.grnmultiList[p] + ' , ';
                            // console.log(this.grnmultiList,'this.grnmultiList*****************');
                            // for(var x=0 ; x < this.grnmultiList.length; x++)
                            // {
                            //   this.grnString += this.grnmultiList[x];

                            // }

                            // this.grnString = this.grnString.replace(/,\s*$/, "");

                            console.log(this.grnString, 'this.grnString*****************');
                            if (parseFloat($('#AcceptedQtyId' + p).val()) < parseFloat(this.invoicedata[p].QUANTITY)) {
                              this.shortpresent = true;
                              this.CreateCreditAdviceModel = new createCreditAdviceModel();
                              this.CreateCreditAdviceModel.invoicenumber = this.invoicedata[p].INVOICENUMBER;
                          ...
                          if (this.shortpresent == true) {
                            ...
                            this.trackOrderListService.createCreditAdvice(this.creditAdviceArray).subscribe(res3 => {
                              ...
                              if (res3[0].message = "shortfall Creditadvice created Sucess") {
                                if (res3[0].grn != "") {
                                  ...
                                  this.loaderservice.hide();
                                  const dialogConfig = new MatDialogConfig();
                                  if (res3[0].warningMessage != "" && res3[0].warningMessage != null
                                    && res3[0].warningMessage != "null") {
                                    var showmessage = 'GRN No.' + this.grnString + ' created for Invoice No. ' + this.invoicedata[0].INVOICENUMBER + '. Request for Credit Note sent to the Vendor. WARNING: ' + res3[0].warningMessage;

                                  }
                                  else {
                                    var showmessage = 'GRN No.' + this.grnString + ' created for Invoice No. ' + this.invoicedata[0].INVOICENUMBER + '. Request for Credit Note sent to the Vendor';
                            ...
                            if (res[0].grn != "") {
                              ...
                              if (res[0].warningMessage != "" && res[0].warningMessage != null
                                && res[0].warningMessage != "null") {
                                var showmessage = 'GRN No.' + this.grnString + ' created for Invoice No. ' + this.invoicedata[0].INVOICENUMBER + '. WARNING: ' + res[0].warningMessage;

                              }
                              else {
                                var showmessage = 'GRN No.' + this.grnString + ' created for Invoice No. ' + this.invoicedata[0].INVOICENUMBER;
              ...
              this.internalportalservice.updateacceptedservicequantityofinvoiceforsimpo(this.invoicesubmissionarray).
                subscribe(res => {
                  ...
                  if (res[0].message == "Success") {
                    ...
                    this.grnnumberlistcommaseperated = res[0].grnlist;
                    this.scrnnumberlistcommaseperated = res[0].scrnlist;
                    // this.scrnNumber = this.scrnnumberlistcommaseperated;
                    console.log("===============>", this.scrnnumberlistcommaseperated);
            ...
            if (!this.invoicedata[0].LINEITEMNUMBER.includes('-')) {
              this.internalportalservice.updateacceptedquantityofinvoicewithoutgrnforsimpo(this.invoicesubmissionarray).
                subscribe(res => {
                      ...
                      subscribe(res1 => {
                        if (res1[0].message == "Success") {
                          for (var p = 0; p < this.invoicedata.length; p++) {
                            if (parseFloat($('#AcceptedQtyId' + p).val()) < parseFloat(this.invoicedata[p].QUANTITY)) {
                              this.grnmultiList.push(res[0].grn[0].this.invoicedata[p].PO_NUMBER);
                              console.log(this.grnmultiList, 'this.grnlist*****************')
                              this.shortpresent = true;
                              this.CreateCreditAdviceModel = new createCreditAdviceModel();
                              this.CreateCreditAdviceModel.invoicenumber = this.invoicedata[p].INVOICENUMBER;
                              this.CreateCreditAdviceModel.lineitemnumber = this.invoicedata[p].LINEITEMNUMBER;
              ...
              this.internalportalservice.updateacceptedservicequantityofinvoicewithoutgrnforsimpo(this.invoicesubmissionarray).
                subscribe(res => {
                      ...
                      subscribe(res1 => {
                        if (res1[0].message == "Success") {
                          ...
                          if (this.shortpresent == true) {
                            ...
                            const dialogConfig = new MatDialogConfig();
                            dialogConfig.data = {
                              message: 'Add email IDs of end user’s on whose behalf you are accepting deliveries. End User will be notified and will need to confirm/accept too.',
                              condition: 'note',
                              page: 'grndoneofapproval'
                            };
                            const mydata = dialogConfig.data;
  ...
  returnInvoice() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (this.confirmationValue == true) {
        ...
        this.internalportalservice.getEndUserReturnSimpo(this.enduserReturnArray).subscribe(res => {
  ...
  checklength(type) {
    console.log("in", $('#enduserremarks').val().length);
    if (type == 'remark') {
      let count_elements = $('#enduserremarks').val().length;
      this.remarklength = 160 - count_elements;
    }

  }

  downloadMultiPo(po_number, singlepodownload) {
    // this.loaderservice.show();
    console.log(po_number);
    this.DecodedFile = [];
    this.trackOrderListService.getfile(po_number, singlepodownload)
  ...
  toggle1(){
    ...
    if ($('#showId1').hasClass('showNothing')){
      $('#showId1').removeClass('showNothing');
    }else{
      $('#showId1' ).addClass('showNothing');
    }
    if ($('#messagescrollMore1' ).hasClass('showNothing')){
      $('#messagescrollMore1' ).removeClass('showNothing');
      $('#messagescrollMore1').addClass('showMore');
      $('#messagescrollMore1' ).toggleClass('showMore');
    }else{
      $('#messagescrollMore1' ).removeClass('showMore');
      $('#messagescrollMore1' ).addClass('showNothing');
    }
  ...
  toggle2(){
    if ($('#showId2').hasClass('showNothing')){
      $('#showId2').removeClass('showNothing');
    }else{
      $('#showId2' ).addClass('showNothing');
    }
    if ($('#messagescrollMore2' ).hasClass('showNothing')){
      $('#messagescrollMore2' ).removeClass('showNothing');
      $('#messagescrollMore2').addClass('showMore');
      $('#messagescrollMore2' ).toggleClass('showMore');
    }else{
      $('#messagescrollMore2' ).removeClass('showMore');
      $('#messagescrollMore2' ).addClass('showNothing');
    }
  }

  toggle3(){
    if ($('#showId3').hasClass('showNothing')){
      $('#showId3').removeClass('showNothing');
    }else{
      $('#showId3' ).addClass('showNothing');
    }
    if ($('#messagescrollMore3' ).hasClass('showNothing')){
      $('#messagescrollMore3' ).removeClass('showNothing');
      $('#messagescrollMore3').addClass('showMore');
      $('#messagescrollMore3' ).toggleClass('showMore');
    }else{
      $('#messagescrollMore3' ).removeClass('showMore');
      $('#messagescrollMore3' ).addClass('showNothing');
    }
  }
