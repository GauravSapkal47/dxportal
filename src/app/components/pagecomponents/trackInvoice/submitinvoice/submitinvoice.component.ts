...
export class SubmitInvoiceComponent implements OnInit {
  ...
  onFileChanged(event: any) {
    ...
    if (this.filecount == 0) {
      ...
      if (this.ArrayOfSelectedFile.length < 11) {
        ...
        for (var k = 0; k < this.ArrayOfSelectedFile.length; k++) {
          ...
          this.ArrayOfSelectedSavedFile.push("invoicewithoutposupportingfiles" + "_invoice_" + this.getFileNameWOExtention(this.ArrayOfSelectedFile[k].name) + "_" + this.timestampnow + "." + this.getExtensionOfFile(this.ArrayOfSelectedFile[k].name));
   ...
   // this.dialogBox.popUpOpen2('Duplicate files are not allowed.', 'error', 'invoicesubmit');
          ...
          if (this.ArrayOfSelectedFile.includes(file) === false) {
            ...
            this.ArrayOfSelectedSavedFile.push("invoicewithoutposupportingfiles" + "_invoice_" + this.getFileNameWOExtention(file.name) + "_" + this.timestampnow + "." + this.getExtensionOfFile(file.name));
  ...
  uploadfileofsupportingdocs() {
    ...
    for (var i = 0; i < this.ArrayOfSelectedFile.length; i++) {
      ...
      console.log("this.ArrayOfSelectedFile[i].name ==> " + "invoicewithoutposupportingfiles" + "_invoice_" + this.getFileNameWOExtention(this.ArrayOfSelectedFile[i].name) + "_" + this.timestampnow + "." + this.getExtensionOfFile(this.ArrayOfSelectedFile[i].name));
      formData.append("file[]", this.ArrayOfSelectedFile[i], "invoicewithoutposupportingfiles" + "_invoice_" + this.getFileNameWOExtention(this.ArrayOfSelectedFile[i].name) + "_" + this.timestampnow + "." + this.getExtensionOfFile(this.ArrayOfSelectedFile[i].name));
    }
