...
export class InvoiceSimpoComponent implements OnInit {
  ...
  temppodata: any = [];
  checkedpo: any = [];
  overallsimpoAmountCheck: boolean;
  tempsimpoSelectedPo: any = [];
  tempposimponewList: any = [];
  tempinputBalanceQuantitysimpo: number;
  tempcheckedpo: any = [];

  simpoPreviouslySelectedPo: any = [];
      ...
      if (this.TypeNo == 'resubmit') {
        ...
        if (this.multiponumber != undefined) {
          ...
          if (this.mpodata != 'null') {
            ...
            this.simpoPreviouslySelectedPo=this.simpoSelectedPo;
            this.checkedpo=this.simpoSelectedPo;
            console.log(this.simpoPreviouslySelectedPo, 'this.simpoPreviouslySelectedPo')
          }
          else {
            this.simpoSelectedPo = [];
            this.simpoPreviouslySelectedPo=[];
            this.checkedpo = [];
          }
        }
        else {
      ...
      if (this.uniquelineitems.length != 0) {
        ...
        this.trackOrderListService.getlistitemsforinvoicenumber(this.invNo, this.ponumber).subscribe(res => {
          if (res[0].message == "Success") {
            ...
            console.log("this.invoicedata[0].ACTUALFILENAME : ",this.invoicedata[0].ACTUALFILENAME);
                  ...
                  for (let k = 0; k < this.posimponewList.length; k++) {
                    ...
                    if (this.simpoSelectedPo[a] == this.posimponewList[k].PO_NUMBER) {
                      ...
                      if ((this.simpoinvoicedata[n].PO_NUMBER == this.posimponewList[k].PO_NUMBER)
                        ...
                        this.calculatesimpo(a, k, this.posimponewList[k].RATEPERQTY, 'normal')
                        break;
                      }
                    }
      ...
      if ((this.viewUploadFile != null && this.viewAttachmentName != null && this.viewAttachmentName != "") ||
        ...
        */
        ...
        for (var l = 0; l < this.poSimpoUniquelineitem.length; l++) {
          ...
          console.log("Previous Invoice number: ",this.invNo);
          console.log("Previous PO number: ",this.simpoPreviouslySelectedPo);
          if(this.invNo!=null&&this.invNo!=undefined&&this.invNo!=''){
            this.customDelivery.previnvno=this.invNo;
          }else{
            this.customDelivery.previnvno="";
          }
          this.customDelivery.prevponos="";
          if(this.simpoPreviouslySelectedPo!=null){
            for(var i=0;i<this.simpoPreviouslySelectedPo.length;i++ ){
              this.customDelivery.prevponos=this.customDelivery.prevponos+this.simpoPreviouslySelectedPo[i]+",";
            }
            console.log("BF POS - "+this.customDelivery.prevponos);
            this.customDelivery.prevponos = this.customDelivery.prevponos.substring(0, this.customDelivery.prevponos.length - 1);
            console.log("AF POS - "+this.customDelivery.prevponos);
          }
          // this.customDelivery.previnvno=this.invNo;
          // this.customDelivery.prevponos=this.simpoSelectedPo.toString;
  ...
  close() {
    ...
    this.actualfilenameofwopo=null;
    this.savedfilenameofwopo=null;
  ...
  showPopup() {
    this.podropdownList = [];
    console.log("this.selectedDropdownPO ", this.selectedDropdownPO);
    var newlist = [];
    ...
    this.purchaseOrderListService.simPoProcessedPos(this.ponumber, this.plantType).subscribe(res => {
      ...
      for (let j = 0; j < this.dropdownList.length; j++) {
        ...
        console.log(this.checkedpo.includes(this.dropdownList[j].PO_NUMBER));
        if (this.dropdownList[j].PO_NUMBER != this.ponumber
          && (!this.checkedpo.includes(this.dropdownList[j].PO_NUMBER))) {
  ...
  calculatesimpo(i, j, rate, source) {
    console.log(" Values================>", i, j, rate, $('#inputQtysimpo' + i + j).val());
    this.calculatedAmountsimpo = 0;
    this.inputBalanceQuantitysimpo = 0;
    if ($('#inputQtysimpo' + i + j).val() == 0 || $('#inputQtysimpo' + i + j).val() == "") {
      ...
      for (let a = 0; a < this.simpoSelectedPo.length; a++) {
        ...
        for (let b = 0; b < this.posimponewList.length; b++) {
          ...
          if (this.posimponewList[b].PO_NUMBER == this.simpoSelectedPo[a]) {
            ...
            // console.log("this.overallAmountsimpo--", this.overallAmountsimpo);
            // console.log(this.invoiceForm.controls['calRealtimesimpo' + a + b].value);
            // console.log("==> ordervaluesimpo" +this.invoiceForm.controls['orderValuesimpo' + a + b].value);
            // console.log($('#inputQtysimpo' + i + j).val());

            this.overallAmountsimpo += this.invoiceForm.controls['calRealtimesimpo' + a + b].value;
            // console.log("==============> this.overallAmountsimpo", this.overallAmountsimpo);
            // console.log("this.invoiceForm.controls['calRealtimesimpo' + a + b].value "+this.invoiceForm.controls['calRealtimesimpo' + a + b].value +"a ==>"+a +"b ==>"+b);
            this.finalTotalAmount += this.invoiceForm.controls['calRealtimesimpo' + a + b].value;
            // console.log("Number"+this.inputBalanceQuantitysimpo);
            // if(source == 'normal')
            // {
            this.inputBalanceQuantitysimpo += Number(this.invoiceForm.controls['orderValuesimpo' + a + b].value);

            // }
            // else if(source == 'remove'){
            //   console.log("$('#inputQtysimpo' + i + j).val() "+$('#inputQtysimpo' + i + j).val()+"i ==>"+i+"j ==>"+j);
            //   this.inputBalanceQuantitysimpo  += Number($('#inputQtysimpo' + i + j).val());
            // }
            //  console.log("==============> inputBalanceQuantitysimpo", this.inputBalanceQuantitysimpo);
            // if (isNaN(this.overallAmountsimpo) || isNaN(this.inputBalanceQuantitysimpo)) {
            // }
          }

        }
        // console.log("this.overallAmountsimpo "+this.overallAmountsimpo +"a++=>" +a);
        this.invoiceForm.controls['overallsimpoAmount' + a].setValue(this.overallAmountsimpo);
        // console.log("this.inputBalanceQuantitysimpo "+this.inputBalanceQuantitysimpo+"a==>"+a);
        this.invoiceForm.controls['inputBalanceQuantitysimpo' + a].setValue(this.inputBalanceQuantitysimpo);
        this.invoiceForm.controls['totalOrderQty'].setValue(this.inputBalanceQuantitysimpo);
        // $("#inputBalanceQuantitysimpo" + a).val(this.overallAmountsimpo)
    ...
    this.finalTotalAmount += this.overallAmount;
    console.log("this.overallAmount: ",this.overallAmount);
    if(this.TypeNo!="resubmit"&&(this.overallAmount==0 ||this.overallAmount== 0.0)){
      this.overallsimpoAmountCheck = true;
    }
    console.log("this.overallsimpoAmountCheck : ",this.overallsimpoAmountCheck);
  }
  ...
  removepo(index, ponumber) {
    
    this.tempcheckedpo = this.checkedpo.filter(element => element != ponumber);
    this.tempsimpoSelectedPo = this.simpoSelectedPo.filter(element => element != ponumber);

    this.tempposimponewList = this.posimponewList.filter(element => element.PO_NUMBER != ponumber);
    this.checkedpo = this.tempcheckedpo;
    this.posimponewList = this.tempposimponewList;
    this.simpoSelectedPo = this.tempsimpoSelectedPo;

    setTimeout(() => {
      // console.log("entered"+this.simpoSelectedPo.length);
      // console.log("this.simpoSelectedPo ",this.simpoSelectedPo);
      // console.log("this.posimponewList ", this.posimponewList);
      
      this.finalTotalAmount = 0;
      for (var k = 0; k < this.simpoSelectedPo.length; k++) {
        this.overallAmountsimpo = 0;
        this.inputBalanceQuantitysimpo = 0;
        for (var z = 0; z < this.posimponewList.length; z++) {
          // this.calculatesimpo(k, z, this.posimponewList[z].RATEPERQTY, 'remove');
          if(this.simpoSelectedPo[k] == this.posimponewList[z].PO_NUMBER)
          {
            if ($('#inputQtysimpo' + k + z).val() == 0 || $('#inputQtysimpo' + k + z).val() == "") {
           
              this.calculatedAmountsimpo = 0 * parseFloat(this.posimponewList[z].RATEPERQTY)
            }
            else {
              this.calculatedAmountsimpo = parseFloat($('#inputQtysimpo' + k + z).val()) * parseFloat(this.posimponewList[z].RATEPERQTY)
            }
            // this.overallAmountsimpo = 0;
            
            console.log("total===========>"+k+" z==> "+z, this.calculatedAmountsimpo);
            this.invoiceForm.controls['calRealtimesimpo' + k + z].setValue(Math.round(Number(this.calculatedAmountsimpo) * 100) / 100);
          
            //  --------------------------------------------
            // if (this.posimponewList[z].PO_NUMBER == this.simpoSelectedPo[k]) {
              this.overallAmountsimpo += this.invoiceForm.controls['calRealtimesimpo' + k + z].value;
              // this.finalTotalAmount += this.overallAmountsimpo;
              // console.log("$('#inputQtysimpo' + k + z).val() "+$('#inputQtysimpo' + k + z).val());
              this.inputBalanceQuantitysimpo += Number($('#inputQtysimpo' + k + z).val());
              // this.inputBalanceQuantitysimpo += Number(this.invoiceForm.controls['orderValuesimpo' + k + z].value);
        }
        }
        // console.log("this.inputBalanceQuantitysimpo "+this.inputBalanceQuantitysimpo);
        this.finalTotalAmount = this.finalTotalAmount + Number(this.overallAmountsimpo);
        console.log("this.overallAmountsimpo "+this.overallAmountsimpo);
        console.log("this.finalTotalAmount "+this.finalTotalAmount);
        this.invoiceForm.controls['overallsimpoAmount' + k].setValue(this.overallAmountsimpo);
        this.invoiceForm.controls['inputBalanceQuantitysimpo' + k].setValue(this.inputBalanceQuantitysimpo);
        this.invoiceForm.controls['totalOrderQty'].setValue(this.inputBalanceQuantitysimpo);
        // $("#overallsimpAmount" + k).val(this.overallAmountsimpo)

        if (this.invoiceForm.controls['overallsimpoAmount' + k].value == 0) {
          this.overallsimpoAmountCheck == true;
        }
        else {
          this.overallsimpoAmountCheck == false;
  ...
  submitpono() {
    ...
    this.selectedDropdownPO.forEach(element => {
      ...
      this.checkedpo.push(element.PO_NUMBER);
    ...
    this.purchaseOrderListService.simpoEventDetails(this.simpoSelectedPo).subscribe(res => {
      ...
      console.log(res);
      this.temppodata = res[0].poData;
      this.temppodata.forEach(element => {
        var found = false;
        this.posimponewList.forEach(element1 => {
          console.log("element1 " + element1.PO_NUMBER + "element.PO_NUMBER " + element.PO_NUMBER);
          if (element1.PO_NUMBER == element.PO_NUMBER) {
            found = true;

          }
        })
        if (found == false) {
          this.simpleuniquelineitems.push(element);
        }
      ...
      console.log(" this.simpleuniquelineitems 01---", this.simpleuniquelineitems);
      ...
      for (let i = 0; i < this.simpleuniquelineitems.length; i++) {
        var found = false;
        for (let j = 0; j < this.posimponewList.length; j++) {
          if (this.posimponewList[j].PO_NUMBER == this.simpleuniquelineitems[i].PO_NUMBER
            && this.posimponewList[j].LINEITEMNUMBER == this.simpleuniquelineitems[i].LINEITEMNUMBER) {
            found = true;

          }
        }
        if (found == false) {
          this.posimponewList.push(this.simpleuniquelineitems[i])
