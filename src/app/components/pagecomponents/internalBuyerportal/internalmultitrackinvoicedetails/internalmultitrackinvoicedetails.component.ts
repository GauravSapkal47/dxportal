...
@Component({
  selector: 'app-internalmultitrackinvoicedetails',
  templateUrl: './internalmultitrackinvoicedetails.component.html',
  styleUrls: ['./internalmultitrackinvoicedetails.component.css']
})
export class InternalmultitrackinvoicedetailsComponent implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute,
    ...
    private trackOrderListService: TrackOrderListService,public dialog: MatDialog,
    ...
    ngOnInit(): void {
      this.route.queryParams.subscribe(params => {
        ...
        console.log("data is here =>"+this.data); // popular
      ...
      // this.internalportalservice.getlistitemsforinvoicenumbers(this.data, this.ponumber).subscribe(res => {
        this.internalportalservice.getlistitemsforinvoicenumbersS(this.data, this.multiPOFinalList).subscribe(res => {
