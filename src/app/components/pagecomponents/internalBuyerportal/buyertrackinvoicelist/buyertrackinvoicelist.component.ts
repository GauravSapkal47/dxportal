...
if(data1.emailId !=null && data1.emailId !="" && data1.page=="viewinvoices")
{
  ...
  multiPOData(invoicenumber, ponumber,multiponumber) {
    ...
    {
      this.router.navigate(['./Internalmultitrackinvoicedetails'], { queryParams: { order: btoa(invoicenumber), po: btoa(ponumber), mpo: btoa(multiponumber),origin:btoa('trackinvoice')  } });
    }
  }
  ...
  getInvoiceData(pageno) {
    ...
    this.internalportalservice.getInvoicesbasedonUserTypeSimpo(this.emailid, pageno, this.currstatus, 'NA', 'NA', 'NA', 'NA', 'NA', 'NA').subscribe(res => {
  ...
  trackPayment(searchponumber, searchlineitemnumber, searchordernumber) {
    ...
    this.internalportalservice.getInvoicesbasedonUserTypeSimpo(emailid, this.paginationpagenumber, 
 ...
 this.trackOrderListService.downloadEncryptedFile(data,this.extensionType);          }
  ...
  sortdata(status) {
    ...
    var emailid = sessionStorage.getItem("username");
    this.internalportalservice.getInvoicesbasedonUserTypeSimpo(emailid, this.paginationpagenumber, this.currstatus, 'NA', 'NA', 'NA', 'NA', 'NA', 'NA').subscribe(res => {
      if(res[0].invoiceCountAsPerStatus)
      {
        this.invoiceCountAsPerStatus = res[0].invoiceCountAsPerStatus;
        if(this.invoiceCountAsPerStatus?.P == null && this.invoiceCountAsPerStatus?.M != null){
  ...
  gettrackInvList(action) {
    ...
    {
      this.internalportalservice.getInvoicesbasedonUserTypeSimpo(this.emailid, this.paginationpagenumber, this.currstatus, this.innum, this.ponum, this.fd, this.td,this.plant,this.vendor).subscribe(res => {
        if(res[0].invoiceCountAsPerStatus)
        {
          this.invoiceCountAsPerStatus = res[0].invoiceCountAsPerStatus;
          if(this.invoiceCountAsPerStatus?.P == null && this.invoiceCountAsPerStatus?.M != null){
    ...
    {
      this.internalportalservice.getInvoicesbasedonUserTypeSimpo(this.emailid, this.paginationpagenumber, this.currstatus, 'NA', 'NA', 'NA', 'NA','NA','NA').subscribe(res => {
        if(res[0].invoiceCountAsPerStatus)
      {
        this.invoiceCountAsPerStatus = res[0].invoiceCountAsPerStatus;
        if(this.invoiceCountAsPerStatus?.P == null && this.invoiceCountAsPerStatus?.M != null){
  ...
  getVendorData(e) {
    ...
    // ***************************Tooltip 07/10/2022***********************************
    onMouseEnter() {
      this.statusTemplate2 = true;
    }
    onClick() {
      this.statusTemplate2 = false; 
    }
